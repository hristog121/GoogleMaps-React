...
class MapSet extends React.Component {
  ...
  renderMarkersOnMap = () => {
    ...
    const customMarker =
      "http://thaitravel.codeitfactory.com/wp-content/uploads/2019/01/sweden_flag-e1548877623661.png";
  ...
  createMarkerInfoWindow = title => {
    const content = ReactDOMServer.renderToString(<InfoWindow title={title} />);
